            ...
            <div className="contactContainer__form--text">
                ...
                >
                    ...
                    <div className="inputContainer__each">
                            ...
                            {isValid? (<button className="inputContainer__button" type="submit">Enviar mensaje</button>) : (<button className="inputContainer__button--disabled" >Enviar mensaje</button>)}
                            {sentForm ?
